...
import { BUSINESS_NAME, DASHBOARD_CONFIG } from '../config';
...
const Dashboard = () => {
  ...
  const [medSpaLogoLoaded, setMedSpaLogoLoaded] = useState(false);
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <img 
              ...
              alt=""
              className="hidden"
              onLoad={() => setMedSpaLogoLoaded(true)}
              onError={() => setMedSpaLogoLoaded(false)}
            />
          </div>
        </div>
